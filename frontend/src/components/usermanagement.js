...
const UserManagement = () => {
    ...
    const fetchUsuarios = () => {
        axios.get('http://localhost:3000/users') // Corrigido para a rota correta
            .then(response => {
    ...
    const addUsuario = () => {
        axios.post('http://localhost:3000/users', newUsuario) // Corrigido para a rota correta
            .then(() => {
    ...
    const updateUsuario = () => {
        axios.put(`http://localhost:3000/users/${editUsuario.id}`, editUsuario) // Corrigido para a rota correta
            .then(() => {
                fetchUsuarios(); // Refresh list
                setEditUsuario(null);
            })
    ...
    const deleteUsuario = (id) => {
        axios.delete(`http://localhost:3000/users/${id}`) // Corrigido para a rota correta
            .then(() => {
                fetchUsuarios(); // Refresh list
            })
            .catch(error => {
